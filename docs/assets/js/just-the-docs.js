(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://unread.parthshah.ml/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://unread.parthshah.ml/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://unread.parthshah.ml/assets/css/just-the-docs-' + theme + ".css"
      );
    };
